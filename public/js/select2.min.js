        ...
        return e && e.requirejs || (e ? n = e : e = {}, m = {}, v = {}, y = {}, _ = {}, i = Object.prototype.hasOwnProperty, a = [].slice, w = /\.js$/, f = function (e, t) {
            ...
            return f.Extend(r, f.Observable), r.prototype.render = function () {
                ...
                this.$results.attr("id", n), t.on("results:all", function (e) {
                    ...
                    if (!(n >= t.length)) {
                        ...
                        var i = l.$results.offset().top + l.$results.outerHeight(!1),
                            s = r.offset().top + r.outerHeight(!1), o = l.$results.scrollTop() + s - i;
                ...
                if (0 !== e.length) {
                    var t = this.$results.find("[aria-selected]").index(e), n = this.$results.offset().top,
                        r = e.offset().top, i = this.$results.scrollTop() + (r - n), s = r - n;
            ...
            return e.prototype.bind = function (e, t, n) {
                ...
                var e = f(window), t = this.$dropdown[0].classList.contains("select2-dropdown--above"),
                    n = this.$dropdown[0].classList.contains("select2-dropdown--below"), r = null,
                ...
                var o = this.$dropdown.outerHeight(!1), a = e.scrollTop(), l = e.scrollTop() + e.height(),
                    c = a < i.top - o, u = l > i.bottom + o, d = {left: i.left, top: s.bottom},
